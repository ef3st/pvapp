...
def set_logger(log_level):
    setup_logger("pvapp", log_level=log_level, use_queue=True)
    return get_logger("pvapp")
...
def main():
    ...
    parser.add_argument(
        "--debug", dest="log_level", action="store_const", const="DEBUG"
    )
    parser.add_argument("--info", dest="log_level", action="store_const", const="INFO")
    parser.add_argument(
        "--warning", dest="log_level", action="store_const", const="WARNING"
    )
    parser.add_argument(
        "--critical", dest="log_level", action="store_const", const="CRITICAL"
    )
